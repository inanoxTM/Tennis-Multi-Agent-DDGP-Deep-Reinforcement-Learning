...
![Trained Agent](/images/model.gif)
...
To run the algorithm, open and run the file Tennis.ipynb. 
In case you want to change any parameter, modify the file utils.py . 
